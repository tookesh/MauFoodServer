...
import com.dissert.cs.maufoodserver.Model.Category;
import com.dissert.cs.maufoodserver.ViewHolder.MenuViewHolder;
...
//                        .setAction("Action", null).show();
    ...
    private void showDialog() {
        ...
        alertDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                // Create new Category
                if(newCategory != null) {
                    mDatabaseReference.push().setValue(newCategory);
                    Toast.makeText(Home.this, "New category: " + newCategory.getName(), Toast.LENGTH_SHORT).show();
    ...
    private void uploadImage() {
        ...
        String imageName = getFileName(saveUri);
        Log.d("MauFood", "Name: " + imageName);
        final StorageReference imageFolder = mStorageReference.child("image/" + imageName);
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        imageFolder.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                // Set Value for newcategory if image successfully uploaded and we can get the download link
        ...
        adapter = new FirebaseRecyclerAdapter<Category, MenuViewHolder>(
            ...
            protected void populateViewHolder(MenuViewHolder viewHolder, Category model, int position) {
                ...
                Picasso.with(Home.this).load(model.getImage())
                        .into(viewHolder.mMenuImageView);
            }
        };

        // Refresh data if there is some changes
